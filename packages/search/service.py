...
SYNONYMS: dict[str, list[str]] = {
    ...
    # Delivery-type-ambiguous everyday wording — present BOTH deliveries, never
    # arbitrarily pick one. Two candidates make resolve_search return AMBIGUOUS.
    "childbirth": ["vaginal delivery", "cesarean delivery"],
    "give birth": ["vaginal delivery", "cesarean delivery"],
    "have a baby": ["vaginal delivery", "cesarean delivery"],
    "having a baby": ["vaginal delivery", "cesarean delivery"],
    "labor and delivery": ["vaginal delivery", "cesarean delivery"],
    # Natural birth is unambiguously vaginal.
    ...
    "physical therapist": ["physical therapy evaluation"],
    "urgent care": ["urgent care visit"],
    "walk in clinic": ["urgent care visit"],
