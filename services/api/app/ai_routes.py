...
from services.ai.provider import OpenAICompatibleProvider
...
def _orchestrator() -> CareveroAIOrchestrator:
    provider = None
    if api_settings.ai_provider_endpoint and api_settings.ai_provider_api_key:
        provider = OpenAICompatibleProvider(
            endpoint=api_settings.ai_provider_endpoint,
            api_key=api_settings.ai_provider_api_key,
        )
    return CareveroAIOrchestrator(
        provider=provider,
        model=api_settings.ai_explanation_model,
